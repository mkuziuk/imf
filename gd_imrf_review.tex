...
\centering
\makebox[\linewidth][c]{%
\includegraphics[width=1.12\linewidth,height=0.84\textheight,keepaspectratio]{figures/gd_imrf/imf_stages_top.png}%
}
...
\centering
\makebox[\linewidth][c]{%
\includegraphics[width=1.12\linewidth,height=0.84\textheight,keepaspectratio]{figures/gd_imrf/imf_stages_bottom.png}%
}
