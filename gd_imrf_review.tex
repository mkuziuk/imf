...
The notebook \href{https://github.com/mkuziuk/imf/blob/main/gd_imrf.ipynb}{gd\_imrf.ipynb}
...
\hline
\end{tabular}
\caption{Main parameters used in \texttt{gd\_imrf.ipynb}.}
\end{table}

\begin{figure}[H]
\centering
\includegraphics[width=\linewidth]{figures/gd_imrf/observed_signal.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=\linewidth]{figures/gd_imrf/lookup_grid.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=\linewidth,height=0.78\textheight,keepaspectratio]{figures/gd_imrf/imf_stages.png}
\caption{For each stage, the notebook shows the residual before filtering, the IMF
removed at that stage, and the residual after subtraction. This grid is the only
plot group with fixed shared \(y\)-axis limits.}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=\linewidth]{figures/gd_imrf/final_comparison.png}
