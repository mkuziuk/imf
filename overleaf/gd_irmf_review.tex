...
The notebook \href{https://github.com/mkuziuk/imf/blob/main/experiments/gd-irmf/gd_irmf.ipynb}{\texttt{gd\_irmf.ipynb}}
...
\hline
\end{tabular}
\caption{Main parameters used in \href{https://github.com/mkuziuk/imf/blob/main/experiments/gd-irmf/gd_irmf.ipynb}{\texttt{gd\_irmf.ipynb}}.}
\end{table}

\begin{figure}[H]
\centering
\includegraphics[width=\linewidth]{figures/gd-irmf/observed_signal.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=\linewidth]{figures/gd-irmf/lookup_grid.png}
...
\centering
\makebox[\linewidth][c]{%
\includegraphics[width=1.12\linewidth,height=0.84\textheight,keepaspectratio]{figures/gd-irmf/imf_stages_top.png}%
}
...
\centering
\makebox[\linewidth][c]{%
\includegraphics[width=1.12\linewidth,height=0.84\textheight,keepaspectratio]{figures/gd-irmf/imf_stages_bottom.png}%
}
...
\begin{figure}[H]
\centering
\includegraphics[width=\linewidth]{figures/gd-irmf/final_comparison.png}
