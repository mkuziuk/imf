...
Metric & Slope \(\beta_1\) & Intercept \(\beta_0\) \\
\hline
Recursive IMF \(\operatorname{RMSE}(e_k)\) & \(1.851\times10^{-3}\) & \(1.078\times10^{-2}\) \\
Single-pass \(\operatorname{RMSE}(d_k)\) & \(8.684\times10^{-3}\) & \(1.145\times10^{-2}\) \\
Recursive IMF \(\operatorname{RMSE}(a^{-k/2}e_k)\) & \(-1.098\times10^{-3}\) & \(1.408\times10^{-2}\) \\
Single-pass \(\operatorname{RMSE}(a^{-k/2}d_k)\) & \(-3.727\times10^{-4}\) & \(2.310\times10^{-2}\) \\
\hline
\end{tabular}
